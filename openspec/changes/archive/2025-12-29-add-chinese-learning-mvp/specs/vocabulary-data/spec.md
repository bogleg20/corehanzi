...
The system SHALL store Chinese sentences with Chinese text, English translation, difficulty score, audio path, and tokenized word array.

#### Scenario: Store filtered sentence

- **WHEN** a Tatoeba sentence passes the 80% HSK coverage filter
- **THEN** the system stores the sentence with its tokens and difficulty score

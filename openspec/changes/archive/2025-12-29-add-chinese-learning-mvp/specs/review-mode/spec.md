...
- **THEN** the system displays Chinese sentence and user must recall/reveal English translation

#### Scenario: Cloze deletion card

- **WHEN** showing cloze card
- **THEN** the system displays sentence with target word blanked (e.g., "我___咖啡") and user fills in

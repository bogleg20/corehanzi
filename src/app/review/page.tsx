...
import { Word, Sentence, WordProgress } from "@/lib/db/schema";
  ...
  const renderCard = () => {
    switch (cardType) {
      ...
      case "sentence":
        ...
        return (
          <div className="bg-white rounded-xl shadow-lg p-8">
            <p className="text-2xl text-gray-900 mb-4">{sentence.chinese}</p>
            {revealed && (
      ...
      case "cloze":
        ...
        return (
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            <p className="text-2xl text-gray-900 mb-4">{clozeText}</p>
